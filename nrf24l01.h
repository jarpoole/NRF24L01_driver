...
uint8_t nrf24l01_check(nrf24l01_platform_t*);

void nrf24l01_set_power_mode(uint8_t, nrf24l01_platform_t*);
void nrf24l01_set_operational_mode(uint8_t, nrf24l01_platform_t*);
void nrf24l01_set_rf_channel(uint8_t, nrf24l01_platform_t*);
void nrf24l01_set_auto_retransmission(uint8_t, uint8_t, nrf24l01_platform_t*);
void nrf24l01_set_address_width(uint8_t, nrf24l01_platform_t*);
void nrf24l01_set_address(uint8_t, const uint8_t*, nrf24l01_platform_t*);
void nrf24l01_set_tx_power(uint8_t, nrf24l01_platform_t*);
void nrf24l01_set_data_rate(uint8_t, nrf24l01_platform_t*);
void nrf24l01_set_crc_scheme(uint8_t, nrf24l01_platform_t*);
void nrf24l01_set_rx_pipe(uint8_t, uint8_t, uint8_t, nrf24l01_platform_t*);
void nrf24l01_close_pipe(uint8_t, nrf24l01_platform_t*);
void nrf24l01_enable_aa(uint8_t, nrf24l01_platform_t*);
void nrf24l01_disable_aa(uint8_t, nrf24l01_platform_t*);
void nrf24l01_set_dynamic_payload_length(uint8_t, nrf24l01_platform_t*);
void nrf24l01_set_payload_with_ack(uint8_t, nrf24l01_platform_t*);
...
void nrf24l01_write_ack_payload(nrf24l01_rx_result, char*, uint8_t, nrf24l01_platform_t*);
